...
import { DefaultOptionsState, type ExtensionToWebviewMessage, type OptionsState, type PanelClientState, type ProjectError, type ProjectInfo, type ProjectUpdateResult, type SortDirection, type SortField, type UpdateFieldValues, type UpdateRequest, type ValidationResult, type WorkspaceSettingsState } from "./Types";
...
export function App() {
  ...
  const handleUpdate = () => {
    if (selectedCount === 0) {
      setStatus("error");
      setStatusMessage("Select at least one project before updating.");
      return;
    }
  ...
  const handleUseAllProjectsChange = (useAllProjects: boolean) => {
  ...
  const handleWorkspaceSolutionChange = (solutionPath: string) => {
    setWorkspaceSettings((currentSettings) => ({
      ...currentSettings,
      solutionPath,
    ...
    setStatus("loading");
    setStatusMessage("Refreshing workspace projects...");
    vscode.postMessage({ type: "setWorkspaceSolution", payload: { solutionPath } });
  };
    ...
    <div className="appShell">
      <div className="workspaceLayout">
        ...
        <BottomPanel
          ...
          onUseAllProjectsChange={handleUseAllProjectsChange}
          onWorkspaceSolutionChange={handleWorkspaceSolutionChange}
